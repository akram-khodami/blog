                ...
                <form action="{{ url('posts/' . $post->id, []) }}" method="post" enctype="multipart/form-data">
                    ...
                    @else
                        <form action="{{ url('posts/', []) }}" method="post" enctype="multipart/form-data">
                            ...
                            <img src="{{ asset('upload/images/'.$post->image) }}" class="img-thumbnail">

                            <a href="{{route('download',['imageName'=>$post->image])}}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="content" rows="10"
                                          name="content">{{ old('content', !empty($post->content) ? $post->content : '') }}</textarea>
                            </div>

                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="published" value="0"
                                       name="published"
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" onclick="show_post_comments('{{ $post->id }}','0')">
                        <a class="nav-link" id="not_confirmed_comments_tab" data-toggle="tab"
                           href="#not_confirmed_comments"
